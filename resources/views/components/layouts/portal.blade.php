    ...
    <body class="dark:bg-zinc-800 min-h-screen bg-white">
        ...
        >
            ...
            <flux:navlist variant="outline">
                <flux:navlist.item
                    ...
                    :href="route('public.listing', ['listing' => auth()->user()->listing])"
                >
                    View My Listing
                </flux:navlist.item>
                ...
                @if (auth()->user()->listing)
                    @if (auth()->user()->listing->pro)
                        <flux:navlist.item icon="at-symbol" :href="route('portal.messages')">
                            Messages
                        </flux:navlist.item>
                        <flux:navlist.item icon="percent-badge" :href="route('portal.coupons')">
                            Coupons
                        </flux:navlist.item>
            ...
            @volt
                <flux:dropdown position="top" align="start" class="max-lg:hidden">
                    <flux:profile
                        avatar="https://ui-avatars.com/api/?name={{ auth()->user()->name }}&color=FFFFFF&background=1B1C20"
                        :name="auth()->user()->name"
                    />
        ...
        @if (config('app.env') == 'local')
            @if (! auth()->user() || auth()->user()->role != 'admin')
                ...
                <script
                    src="https://js.sentry-cdn.com/77ef17e559d3dcfaa706d3923c8c5d84.min.js"
