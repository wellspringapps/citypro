                    ...
                    <div class="container mx-auto">
                        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                            ...
                            <div class="hidden lg:flex lg:gap-x-12">
                                ...
                                <a href="/claim-listing" class="text-sm/6 font-semibold text-gray-900">
                                    Claim Your Listing
                                </a>
                            </div>
            ...
            <footer class="bg-white">
                <div class="container mx-auto px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
                    <div class="flex justify-center gap-x-6 md:order-2">
                        <a
                            href="https://www.facebook.com/people/CircleCityPro/61573290895755/"
                            target="_blank"
                        ...
                        <a
                            href="https://www.instagram.com/circlecitypro/"
                            target="_blank"
                            class="text-gray-600 hover:text-gray-800"
                        >
                    ...
                    <p class="mt-8 text-center text-sm/6 text-gray-600 md:order-1 md:mt-0">
                        &copy; {{ now()->format('Y') }} Wellspring Apps, LLC - All rights reserved.
                    </p>
                </div>
            </footer>
        </div>
